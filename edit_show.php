...
<div id="edit" style="display:block;"  class="pop animated jackInTheBox">
  ...
  <h1 align='center'>EDIT</h1><br>
    <span class="close" onclick="location.href='shows.php'">&times;</span>	
	<?php
	...
	$qry1="select Theatre_Name ,Movie_Name ,time1 ,time2 ,time3 ,time4 ,time5 FROM showst where id='$id'";
...
if( isset($_REQUEST['submit']))
	{	
		...
		$update_qry="UPDATE showst SET Theatre_Name='$theatre',Movie_Name='$movie',time1='$time1',time2='$time2',
		time3='$time3',time4='$time4',time5='$time5' WHERE id='$id'";
